...
## :globe_with_meridians: COLLADA/KML/glTF > :point_right: Streets in Bavaria with WMS and Terrain, thematic Google Spreadsheets :heavy_check_mark:
...
## :dvd: GeoJSON > :point_right: Districts in NRW, thematic OGC Feature API :heavy_check_mark:
...
## :dvd: GeoJSON > :point_right: Districts in NRW, embedded thematic data :heavy_check_mark:
...
## :milky_way: Mixed Layers > :point_right: TUM Buildings in different LODs, Solar Radiation, Vegetation :heavy_check_mark:
...
## :milky_way: Mixed Layers > :point_right: TUM Lane Models with Buildings, Solar Radiation, Vegetation :heavy_check_mark:
...
## :milky_way: Mixed Layers > :point_right: Tokyo Buildings with Bridges, Textures :heavy_check_mark:
