...
For convenient use, there is an official [web link](http://www.3dcitydb.org/3dcitydb-web-map/1.4/3dwebclient/index.html) available that can be called to directly run the 3DCityDb-Web-Map-Client on your web browser. 
